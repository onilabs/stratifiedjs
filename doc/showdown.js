...
_77=_77.replace(/^\n+/g,"");
_77=_77.replace(/\n+$/g,"");
_77="<pre class='prettyprint'>"+_77+"\n</pre>"; //TOM add prettyprint
return _1c(_77)+_78;
});
_73=_73.replace(/~0/,"");
return _73;
...
c=c.replace(/[ \t]*$/g,"");
c=_79(c);
return m1+"<pre class='prettyprint'>"+c+"</pre>"; //TOM add prettyprint
});
return _7b;
};
...
_83=_83.replace(/(\*\*)(?=\S)([^\r]*?\S[*]*)\1/g,"<strong>$2</strong>"); // TOM 
_83=_83.replace(/(\*)(?=\S)([^\r]*?\S)\1/g,"<em>$2</em>"); // TOM
return _83;
};
